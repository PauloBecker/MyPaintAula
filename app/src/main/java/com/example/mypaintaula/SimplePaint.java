...
public class SimplePaint extends View {
    ...
    public SimplePaint(Context context, @Nullable AttributeSet attrs) {
        ...
        public void initLayerDraw(){
            ...
            currentPaint.setStyle(Paint.Style.STROKE);//Para desenhar um traço
            currentPaint.setStrokeWidth(20);//Para definir a largura do traço
    ...
    //Método que vai capturar o evento que o usuário vai tocar na tela
    @Override
